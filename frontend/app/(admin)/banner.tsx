...
//       Alert.alert(
//         "Error",
//         e?.message || "Failed to load banners"
//       );
//     } finally {
//       setLoading(false);
//     }
...
//         "file",
//         blob as any,
//         selectedImageName || "banner.jpg"
//       );

//       // api.ts automatically avoids setting
//       // Content-Type manually for FormData.
//       // This allows fetch to add the correct
//       // multipart boundary.
...
//       // New local image -> upload to Cloudinary.
//       if (
...
//             color={C.muted}
//           >
//             Manage Customer Home promotional
//             banners
//           </Txt>
//         </View>
