...
import { useCallback, useEffect, useRef, useState } from "react";
import { FlatList, Modal, Pressable, StyleSheet, Vibration, View, Platform } from "react-native";
import { Ionicons } from "@expo/vector-icons";
import { useAudioPlayer } from "expo-audio";
import { useFocusEffect, useRouter } from "expo-router";
import { useSafeAreaInsets } from "react-native-safe-area-context";
...
export default function RestaurantOrders() {
  ...
  // ব্যাকগ্রাউন্ড পুশ টোকেন এবং নোটিফিকেশন চ্যানেল সেটআপ
  useEffect(() => {
    (async () => {
      try {
        ...
        const tokenData = await Notifications.getExpoPushTokenAsync({
          projectId: "432acdb2-2296-44a4-9ab2-be0608467b87",
        });
        console.log("MY_PUSH_TOKEN:", tokenData.data);

        // অ্যান্ড্রয়েডের জন্য হাই প্রায়োরিটি চ্যানেল তৈরি
