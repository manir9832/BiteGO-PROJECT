...
export default function RestaurantOrderDetail() {
  ...
  const next: any =
    ({
      ...
      ACCEPTED: [
        ["preparing", "Start Preparing", "primary"],
      ],
      PREPARING: [
        ["ready", "Mark Ready", "primary"],
      ],
    } as Record<
    ...
    >
      ...
      >
        ...
        <View style={styles.block}>
          ...
          <Row
            label="Item Total"
            value={money(o.food_subtotal)}
          />

          <Row
            label="Platform Charge"
            value={money(o.platform_charge)}
          />

          <Row
            label="Delivery Charge"
            value={money(
              o.customer_delivery_charge
            )}
          />
